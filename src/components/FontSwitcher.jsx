...
export default function FontSwitcher(props) {
  ...
  return (
    <select
      className="select select-primary border-primary focus:border-primary border-l-0 focus:outline-0 text-primary-focus hover:text-primary text-sm rounded-none rounded-r-xl cursor-pointer"
